...
[**name**](https://restcountries.eu/#api-endpoints-name) и возвращает промис с
массивом стран - результатом запроса. Вынеси её в отдельный файл
...
используя [**библиотеку notiflix**](https://www.notiflix.com/).
