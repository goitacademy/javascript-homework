...
Для каждого элемента `li.item` в списке `ul.list`, найдет и выведет в консоль
текст заголовка элемента (теге h2) и количество элементов в категории (всех
...
Напиши скрипт сбора информации из формы заказа пиццы при ее сабмите.
...
<form id="order-form">
  ...
  <section>
    ...
    <ul>
      <li>
        <label>
          <input type="radio" name="size" value="маленькая" checked />
          Маленькая
        </label>
      </li>
      <li>
        <label>
          <input type="radio" name="size" value="средняя" checked />
          Стредняя
        </label>
      </li>
      <li>
        <label>
          <input type="radio" name="size" value="большая" />
          Большая
        </label>
      </li>
    </ul>
